...
import { mapDbProjectToProject, mapDbProjectsToProjects } from '@/utils/projectMapping';
import { mapDbSessionToSession, mapDbSessionsToSessions } from '@/utils/sessionMapping';
...
export const DatabaseProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const getProject = async (projectId: number): Promise<Project> => {
    const dbProject = await window.database.getProject(projectId);
    if (!dbProject) {
