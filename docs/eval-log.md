...
|   4 |      | Normalize how “writes that only need { changes }” are represented/returned in renderer code (actions + DatabaseContext + state service), without breaking IPC.                   | `eval-run-v1`                 |              |                          2 |                 2 |                  2 |                             2 |                     2 |                           |                                              |
